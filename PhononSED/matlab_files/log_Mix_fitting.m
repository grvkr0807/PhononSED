...
type= 'log_Mix_fit';    %fitting algorithm 
...
for i=1:Neig
        ...
        P4= 0.5;  % Gaussian or Lorentzian behavior
        P1= (max_SED(i))/(P4 + (1-P4)*(P2^2+P3)/(4*pi*P3^0.5));
        P0= [P1,P2,P3,P4];    %parameters for Lorentzian fit
        BOUNDS= [0,0,0,0;Inf,Inf,Inf,1];
        [SED_fit(index(1,i):index(2,i),i), params(:,i), resnormal(i), residual(index(1,i):index(2,i),i)] = SEDfit_func(freqs(index(1,i):index(2,i)),log_SED(index(1,i):index(2,i),i),P0,BOUNDS,'logmix');
