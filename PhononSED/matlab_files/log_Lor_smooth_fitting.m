...
type= 'log_Lor_smooth_fit';    %fitting algorithm 
...
for i=1:Neig
        ...
        [SED_fit(index(1,i):index(2,i),i), params(:,i), resnormal(i), residual(index(1,i):index(2,i),i)] = SEDfit_func(freqs(index(1,i):index(2,i)),smooth(log_SED(index(1,i):index(2,i),i),'sgolay'),P0,BOUNDS,'loglor');
